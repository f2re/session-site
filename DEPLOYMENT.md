# 🚀 SalePhotosession Website - Руководство по развертыванию

Полное руководство по развертыванию веб-сайта SalePhotosession (AI фотосессии товаров) на платформе [telegram-bots-platform](https://github.com/f2re/telegram-bots-platform).
