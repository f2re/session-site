...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "По умолчанию доступно 4 профессиональных стиля: Lifestyle (товар в реальной обстановке), Studio (классическая студийная съёмка), Interior (товар в интерьере), Creative (креативные композиции). Также стили генерируются ИИ для каждого товара персонально, или вы можете создать собственный стиль! Выбирайте подходящий под вашу задачу!",
  },
  {
